<template>
  <div class="div">
    <v-row justify="center">
      <v-col cols="5">
        <v-card flat>
          <v-card-title class="ml-2">Recommended Jobs</v-card-title>
          ...
          <v-row class="ml-3 mr-3 mb-8 pa-0">
              ...
              <v-card>
                ...
                <v-card-text>
                  ...
                  <v-row class="justify-end mt-4 mr-1">
                    <v-btn class="white--text" width="150px" color="light-blue darken-4" :disabled="!Valid" @click="ApplyJob()" :loading="loading">
                      Apply
                    </v-btn>
                  </v-row>
                </v-card-text>
    ...
    <v-snackbar v-model="snackbar1" timeout="3000" color="success" outlined dark
      ><v-icon class="mr-2">mdi-checkbox-marked-circle</v-icon> Your Application placed successfully
    </v-snackbar>
